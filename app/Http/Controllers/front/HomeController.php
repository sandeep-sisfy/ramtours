...
class HomeController extends Controller {
	...
	function submit_testimonial(Request $request) {
	...
	function serach_flights(Request $request){
	...
	function fly_travel_packages(Request $request) {
	...
	function fly_travel_packages_detail($id) {
	...
	function tourist_info() {
		$data['title']='Tourist Info';
		return view('frontend.pages.tourist_info',$data);
	}
	function search_vacation_packages(Request $request) {		
	...
	function loc_vacation_packages($loc_id) {
	...
	function loc_fly_travel_packages($loc_id) {
		$location=Location::find($loc_id);
		if(empty($location)){
			return redirect('/');
		}
	...
	function search_accommodation_hotel_code(Request $request) {
	...
	function search_accommodation(Request $request) {
		$all_loc=[];
		$data['loc_id']='';	
		$data['loc_name']='';
		$all_loc=array();	
	...
	function accommodation_detail($id) {
...
//dd($page); 
	 ...
	 function submit_contact_page(Request $request) {
		$messages = [
        ];
        $this->validate($request, [
            'first_name' =>  'required',
