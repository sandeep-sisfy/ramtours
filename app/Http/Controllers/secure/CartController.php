...
class CartController extends Controller {
	function setup_cart(Request $request) {
	...
	function put_card_in_temp_cart($package, $adults, $childs,$card){
	...
	function put_cars_in_temp_cart($cars, $adults, $childs, $infants, $date) {
	...
	function put_rooms_in_temp_cart($rooms, $adults, $childs, $date, $pakage_id) {
	...
	function put_flights_in_temp_cart($flight, $adults, $childs) {
		$total_peoples = $adults + $childs;
		$flight_id = 0;
		$error_flight = 0;
	...
	function put_only_flights_in_temp_cart($flight, $adults, $childs) {
		$total_peoples = $adults + $childs;
		$flight_id = 0;
		$error_flight = 0;
		$flight_sch_booked_for = 0;
	...
	function put_profit_total_in_temp_cart($package) {
	...
	function setup_temp_cart($package, $adults, $childs, $infants, $cart_id) {
		if (empty($package)) {
			$temp_cart = array(
				'cart_id' => $cart_id,
	...
	function verify_cart(Request $request) {
		$car_error = 0;
		$flight_error = 0;
		$room_error = 0;
