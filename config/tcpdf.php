...
return [
	...
	'encoding'              => 'UTF-8',
	'font_directory'        => '',
	'image_directory'=>base_path().'/public/assets/pdf/images/',
	'tcpdf_throw_exception' => true,
	'use_fpdi'              => false,
	'use_original_header'   => true,
	'use_original_footer'   => true,
	'header_logo_width'     =>180,
	'header_logo'         => 'pdfheader.jpg', // PDF_HEADER_LOGO
	'image_scale_ratio'  =>1.25,
	'margin_top'          =>37, // PDF_MARGIN_TOP
	'header_title'=>'test',
	'head_magnification'=>1.1,
	'path_cache'=>base_path().'\public\assets\pdf',
