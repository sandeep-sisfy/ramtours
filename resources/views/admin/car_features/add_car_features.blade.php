...
@endphp
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <form action="{{url('/admin/car-features')}}@yield('edit_feature_id')" method="POST" accept-charset="utf-8" id="add_hotel_features" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @section('method_field')
                            @show                            
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="car_feature" value="{!! get_edit_input_pvr_old_value_with_obj('car_feature',$feature,'car_feature')!!}">
                                    {!! get_form_error_msg($errors, 'car_feature') !!}
