        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        {!!show_flash_msg()!!}
                        <form action="{{url('/admin/gallery/'.$gallery_image->id)}}" method="POST" accept-charset="utf-8" id="add_gallery" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT')}}
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="title" value="{!! get_edit_input_pvr_old_value_with_obj('title', $gallery_image , 'title')!!}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="sequence" value="{!! get_edit_input_pvr_old_value_with_obj('sequence', $gallery_image , 'sequence')!!}">
                                    {!! get_form_error_msg($errors, 'sequence') !!}
                                    <label class="form-label">Image sequence</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="previous">Gallery Image: </label>
                                <img src="{{ rami_get_file_url($gallery_image->image) }}" width="75" height="75" alt="location_image">
                            </div>
                            <div class="form-group">
                                <label for="upload">Gallery Images Here : </label>
                                <input name="gallery_image" type="file" class="form-control list_file" />
                                {!! get_form_error_msg($errors, 'gallery_image') !!}
                            </div>
