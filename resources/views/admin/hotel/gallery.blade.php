                ...
                <div class="card">
                    <div class="body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link" href="{{url('admin/hotel/'.$hotel_id.'/edit')}}" data-toggle="tab" onclick="window.location.href='{{url('admin/hotel/'.$hotel_id.'/edit')}}'">hotel Info</a></li>
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="{{url('admin/hotel/gallery/'.$hotel_id)}}">Gellery</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" onclick="window.location.href='{{url('admin/hotel-meta/'.$hotel_id)}}'">Meta data</a></li>
                        </ul>
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane in active" id="home">
                                <form action="{{url('admin/hotel/add_image/'.$hotel_id)}}" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group" style="text-align:center">
                                ...
                                <button type="button" class="btn btn-success btn-primary waves-effect m-t-20 upload_comp" onclick='window.location.href="{{url('/admin/room/create') }}"'>Save & add room
                                </button>
                            </div>
                        ...
                        <form id='del_hotel_img_form' method="POST" action="{{url('admin/hotel/delete_image')}}" style="display: none">
                            {{ csrf_field() }}
                            {{method_field('DELETE')}}
                        </form>
                    </div>
