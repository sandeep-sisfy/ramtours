                    ...
                    <div class="body">
                        ...
                        @section('nav-tabs')
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" onclick="window.location.href='{{url('admin/location/packagemeta/'.$location->id)}}'">Location package Meta data</a></li>

                            </ul>

                        @show

                        <form action="{{url('admin/location/packagemeta/'.$location->id)}}" id="add_location_meta" method="POST" accept-charset="utf-8">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <label class="form-label">Location Package Slug</label>

                                    <input  class="form-control" type="text" name="loc_package_slug" value="{!! get_edit_input_pvr_old_value_with_obj('loc_package_slug',$location,'loc_package_slug')!!}">

                                    {!! get_form_error_msg($errors, 'loc_package_slug') !!}
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <label class="form-label">Location Package Title Text</label>                                   

                                    <input  class="form-control" type="text" name="loc_package_title_text" value="{!! get_edit_input_pvr_old_value_with_obj('loc_package_title_text',$location,'loc_package_title_text')!!}">                                    

                                    {!! get_form_error_msg($errors, 'loc_package_title_text') !!}
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <textarea name="loc_package_header_custom_code" rows="5" style="width:100%;margin-top: -20px" >{!! get_edit_input_pvr_old_value_with_obj('loc_package_header_custom_code',$location,'loc_package_header_custom_code')!!}</textarea>

                                    {!! get_form_error_msg($errors, 'loc_package_header_custom_code') !!}
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <label class="form-label">location Package footer custom code</label>

                                    <br><br>

                                    <textarea name="loc_package_footer_custom_code" rows="5" style="width:100%;margin-top: -20px" >{!! get_edit_input_pvr_old_value_with_obj('loc_package_footer_custom_code',$location,'loc_package_footer_custom_code')!!}</textarea>

                                    {!! get_form_error_msg($errors, 'loc_package_footer_custom_code') !!}
