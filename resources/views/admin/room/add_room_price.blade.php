...
{{-- empty check for edit purpose and helper use--}}
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">                        
                        <form action="{{$form_url}}@yield('edit_price_id')" id="add_room_price" method="POST" accept-charset="utf-8" >
                            {{ csrf_field() }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control start_end_date" name="price_start_date" value="{!! get_edit_input_pvr_old_value_with_obj('price_start_date',$room_price, 'price_start_date')!!}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input type="text" class="form-control start_end_date" name="price_end_date" value="{!! get_edit_input_pvr_old_value_with_obj('price_end_date',$room_price, 'price_end_date')!!}">
                                    {!! get_form_error_msg($errors, 'price_end_date') !!}
                                </div>
                            </div>
                            <!--  <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="room_total" value="{!! get_edit_input_pvr_old_value_with_obj('room_total',$room_price, 'room_total')!!}" >
                            ...
                            <!-- <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="room_available" value="{!! get_edit_input_pvr_old_value_with_obj('room_available',$room_price, 'room_available')!!}">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line"> 
                                    <select class="form-control show-tick price_currency" name="price_currency">
                                        <option value="1" {{get_edit_select_check_pvr_old_value_with_obj('price_currency', $room_price, 'price_currency', 1, 'select')}} >USD Dollar</option>
                                        <option value="2" {{get_edit_select_check_pvr_old_value_with_obj('price_currency', $room_price, 'price_currency', 2, 'select')}} >Euro </option>
                                        <option value="3" {{get_edit_select_check_pvr_old_value_with_obj('price_currency', $room_price, 'price_currency', 3, 'select')}} >Swiss Franc</option>
                                        <option value="4" {{get_edit_select_check_pvr_old_value_with_obj('price_currency', $room_price, 'price_currency', 4, 'select')}}>Shekel</option>
                                    </select>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="price_for_{{ $i }}" value="{!! get_edit_input_pvr_old_value_with_obj('price_for_'.$i,$room_price, 'price_for_'.$i)!!}">
                                    {!! get_form_error_msg($errors, 'price_for_'.$i) !!}
                                    <label class="form-label">Room Price for {{ $i }} people</label>
                                </div>
                            </div>
                            @endfor
                            @endif 
