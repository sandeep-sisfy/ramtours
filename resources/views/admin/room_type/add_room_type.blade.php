 ...
 {!!show_flash_msg()!!}
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="body">
                        <form action="{{url('/admin/room-type')}}@yield('edit_room_id')" method="POST" accept-charset="utf-8" id="add_room_types" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @section('method_field')
                            @show
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="room_type" value="{!! get_edit_input_pvr_old_value_with_obj('room_type',$room,'room_type')!!}">
