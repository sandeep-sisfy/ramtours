            ...
            <div class="card mt-3 tab-card">
              <div class="card-header tab-card-header">
                <ul class="nav nav-tabs card-header-tabs" id="header_search_tab" role="tablist">
                  <li class="nav-item">
                      <a class="nav-link" id="rami_package_tab" data-toggle="tab" href="#rami_package" role="tab" aria-controls="One" aria-selected="true"><img src="{{url('/assets/front/images')}}/rtuf1.png" alt=""><span>חבילות נופש  </span></a>
                  </li>
                 <!--  <li class="nav-item">
                      <a class="nav-link" id="rami_fly_drive_tab" data-toggle="tab" href="#rami_fly_drive" role="tab" aria-controls="Two" aria-selected="false"><img src="{{url('/assets/front/images')}}/rtuf2.png" alt=""><span>חבילות טוס וסע</span></a>
                  </li> -->
                  <li class="nav-item">
                      <a class="nav-link" id="three-tab" data-toggle="tab" href="#three" role="tab" aria-controls="Three" aria-selected="false"><img src="{{url('/assets/front/images')}}/rtuf3.png" alt=""><span>טיסות</span></a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" id="three-tab" data-toggle="tab" href="#four" role="tab" aria-controls="four" aria-selected="false"><img src="{{url('/assets/front/images')}}/rtuf4.png" alt=""><span>דירות נופש</span></a>
                  </li>
                </ul>
              </div>
                ...
                <form action="{{url('/search-vacation-packages')}}" method="GET" accept-charset="utf-8" id="add_hotel_features" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="input-group">
                          <div class="input-group-prepend"><span class="input-group-text">
                            <img src="{{url('/assets/front/images')}}/rtuf10.png"></span></div>
                  ...
                  <div class="row rt_custm">
                      <div class="col-md-12">
                        <div class="input-group input-append date">
                          <div class="input-group-prepend"><span class="input-group-text">
                            <img src="{{url('/assets/front/images')}}/calenderr.png"></span></div>
                  ...
                  <div class="row">
                      <div class="col-md-4">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend"><span class="input-group-text"><img src="{{url('/assets/front/images')}}/user.png"></span></div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend"><span class="input-group-text"><img src="{{url('/assets/front/images')}}/child.png" class="rt_childico"></span></div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend"><span class="input-group-text "><img src="{{url('/assets/front/images')}}/infant.png" class="rt_infantico"></span></div>
                          <select class="d-block w-100 form-control" name="pack_infant" >
                            @for($i=0;$i<7;$i++)
                            <option value="{{ $i }}" @if($i== get_search_infant()) selected="true" @endif>{{ $i }}</option>
                            @endfor
                          </select>
                        </div>
                      </div>
                ...
                <div class="tab-pane fade p-3" id="three" role="tabpanel">
                  ...
                  <div class="row">
                      <div class="col-md-6">
                        <div class="input-group">
                          <div class="input-group-prepend"><span class="input-group-text">
                            <img src="{{url('/assets/front/images')}}/rtuf8.png"></span></div>
                            <select class="d-block w-100 form-control" name="source_location" >
                            <!--<option value="0">--תבחר אחד --</option>-->
                            @foreach($flights_src as $fc)
                            <option value="{{ $fc->id }}">{{ $fc->loc_name }}</option>
                            @endforeach
                       ...
                       <div class="col-md-6">
                          <div class="input-group">
                            <div class="input-group-prepend"><span class="input-group-text">
                              <img src="{{url('/assets/front/images')}}/rtuf9.png"></span></div>
                              <select class="d-block w-100 form-control" name="destination_location">
                             <!-- <option value="0">--תבחר אחד --</option>-->
                              @foreach($flights_desti as $fc)
                              <option value="{{ $fc->id }}">{{ $fc->loc_name }}</option>
                              @endforeach
                            </select>
                          </div>
