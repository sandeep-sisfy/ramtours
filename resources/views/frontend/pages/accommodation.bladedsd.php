  ...
  <section class="test-cont">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="rt_affix">
            <ul class="navbar-nav text-uppercase ml-auto rt_tabs">
               ...
               <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#choose-apartments">לבחור דירות</a></li>
            ...
            <div class="col-md-3 flightss">
              <div class="home-product-box">
                <div class="content-image clearfix">
                  <a href="package-detail.html"><img width="340" height="214" src="{{rami_get_hotel_single_image($hotel->id)}}" class="img-fluid" alt=""></a>
                  <div class="date_code">
                    <div class="dates"></div>
