  ...
  <div class="container">
          ...
          <div class="hotel-room-inner">
            ...
            <div class="hotel-room-heading-left">
              <div class="terms-heading">
                ...
                <div class="terms-heading-small-text">{{$hotel->hotel_code }} <strong>: קוד מקום הלינה </strong>
                  &nbsp;&nbsp{{$hotel->hotel_address }} </div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 ap-cont">
          <h3 class="cont-head">
            ...
            <span>
              <img src="{{url('/assets/front/images')}}/mann.png">&nbsp;מתאים להרכב של עד {{$room['max_people']}} נפשות
              <span dir="ltr">({{$room['room_code']}})</span>|
            </span>
            <span>
    ...
    <div class="pkg-section" id="notes">
      <div class="row">
        <div class="col-md-12 bd-sec">
          <div class="bd-head">
            <h3>הערות לעסקה<img src="{{url('/assets/front/images')}}/notes.png"></h3>
          </div>
        </div>
