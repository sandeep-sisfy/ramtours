  ...
  <section class="rt_frames">
    <div class="container">
       ...
       <div class="col-md-12">
        ...
        <div class="contact-time-icon"><img src="{{url('/assets/front/images')}}/location-icon.jpg" alt=""></div>
        ...
        <div class="content-right col-md-6">
          <div class="content-height">
          <div class="contact-time-icon"><img src="{{url('/assets/front/images')}}/contact-time-icon.jpg" alt=""></div>
