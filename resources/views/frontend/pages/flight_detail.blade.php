    ...
    <div class="container">
     <div class="row flt-inner">
      ...
      <label class="num_lbl">מספר מבוגרים:</label>
        <input type="number" data-current_val="1" min="1" max="99" class="num_passangers adults" value="{{ get_search_adult() }}" id="rami_pakage_adults">
      ...
      <label class="num_lbl">מספר ילדים (2-16):</label>
        <input type="number" data-current_val="0" min="0" max="99" class="num_passangers kids" value="{{ get_search_child() }}" id="rami_pakage_childs">
         <div class="quantity-nav">
            <div class="quantity-button quantity-up rami_incr_btn">+</div>
            <div class="quantity-button quantity-down rami_decr_btn">-</div>
         </div>
      ...
      <label class="num_lbl">מספר תינוקות (0-2):</label>
        <input type="number" data-current_val="0" min="0" max="99" class="num_passangers infants" value="{{ get_search_child() }}" id="rami_pakage_infants">
         <div class="quantity-nav">
            <div class="quantity-button quantity-up rami_incr_btn">+</div>
            <div class="quantity-button quantity-down rami_decr_btn">-</div>
         </div>
