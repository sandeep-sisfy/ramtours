...
<section class="pkg-data">
  <div class="container">
      ...
      <div class="col-md-3 pkgrt-sec">
        <div class="pkg-right" id="pkgrtsec">
          <div class="pkg-box">
            ...
            <div class="pkg-price">
              <div class="pkg-btns"><button class="btn btn-lg btn-primary btn-block checking_cart" type="submit">להזמין
                  עכשיו</button></div>
            ...
            <div class="pkg-frm">
              ...
              <div class="input-group spinner">
                ...
                <div class="input-group-btn-vertical">
                  <button class="btn btn-default rami_incr_btn" type="button"><i class="fa fa-plus"
                      aria-hidden="true"></i></button>
                  <button class="btn btn-default rami_decr_btn" type="button"><i class="fa fa-minus"
                      aria-hidden="true"></i></button>
                </div>
              </div>
        ...
        <div class="pkg-inner">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark" id="rt_affix">
            <ul class="navbar-nav text-uppercase ml-auto rt_tabs">
              <li class="nav-item"><a class="nav-link js-scroll-trigger active" href="#basic-details">חפרטים בסיסיים</a>
              </li>
    ...
    left: 1px;width: 100.4%!important;">תאריכים<img src="{{url('/assets/front/images')}}/date-ico.png"></h3>
                </div>
          ...
          <div class="pkg-section" id="flights">
            <div class="row flt-inner">
              <div class="col-md-12 bd-sec">
                <div class="bd-head">
                  <h3>טיסה<img src="{{url('/assets/front/images')}}/flight-ico.png"></h3>
                </div>
              </div>
                  ...
                  <div class="flight-conttt">
                    ...
                    <div class="flight-secc bottom">
                      <div class="flights-icon"><img width="262" height="165"
                          src="{{url('ramtours/'.$all_flight['down_airline_logo'])}}" class="img-fluid" alt="">
                        <div class="flt_inff">
                      ...
                      <div class="flight-text-box td3">
                        ...
                        <span class="fltt-ttltime">{{$all_flight['down_flight_no']}} {{$all_flight['down_source']}}
                          {{$all_flight['down_desti']}} </span></div>
            ...
            <div class="pkg-section" id="car">
              <div class="row">
                <div class="col-md-12 bd-sec">
                  <div class="bd-head">
                    <h3>רכב <img src="{{url('/assets/front/images')}}/pkg-car.png"></h3>
                  </div>
                </div>
                <div class="col-md-8">
