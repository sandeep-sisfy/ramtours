                ...
                <div class="aprt-inner">
                  <select>
                    ...
                    @foreach($all_flights as $all_flight)
                        <option value="{{$all_flight['id']}}" @if($all_flight['id']==$package->cheapest_flight_sche) selected="true" @endif >{{$all_flight['title']}}</option>
                    @endforeach
                </select>
                </div>
            </div>
                  ...
                  <select  class="rami_pkg_chnage_select chnage_select1" element_no='1' element_name="room">
                    ...
                    @foreach( $hotel_rooms as $room)
                      <option value="{{$room['id']}}" @if($room['id']==$package->cheapest_room) selected="true" @endif >
                        ...
                        <span>
                          &nbsp;מתאים להרכב של עד {{$room['max_people']}} נפשות  <span dir="ltr">({{$room['room_code']}})</span>|
                        </span>
                        <span> 
                ...
                <select  class="rami_pkg_chnage_select chnage_select1" element_no='1' element_name="car">
                    ...
                    @foreach( $all_cars as $car)
                      @if(empty($car['id']))
                          @continue
                      @endif
                      <option value="{{$car['id']}}"  @if($car['id']==$package->cheapest_car) selected="true" @endif >{{$car['car_title']}}</option>
                    @endforeach
                  </select>
                      <a href="javascript:void(0);" class="add_button" title="Add More room"><i class="fa fa-plus" aria-hidden="true"></i></a>
                </div>
        ...
        <div class="col-md-9 pkg-left">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark" id="rt_affix">
            <ul class="navbar-nav text-uppercase ml-auto rt_tabs">
               <li class="nav-item">
                <a class="nav-link js-scroll-trigger active" href="#basic-details">{{get_rami_page_placeholder('basic_details', 1)}}</a>
              </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="#choose-apartments">{{get_rami_page_placeholder('choice_of_apartments', 1)}}</a>
              </li>
              @if($hotel_reviews->count()>0)
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="#reviews-box">{{get_rami_page_placeholder('hotel_review', 1)}}</a>
              </li>
              @endif
              @if(!empty($map))
               <li class="nav-item">
          ...
          <div class="pkg-section" id="basic-details">
           <div class="row">
            ...
            <div class="col-md-4 bd-sec">
              <div class="bd-head"><h3>תאריכים<img src="{{url('/assets/front/images')}}/date-ico.png"></h3> </div>
            ...
            <div class="col-md-3 bd-sec">
              <div class="bd-head"><h3>מקום אירוח<img src="{{url('/assets/front/images')}}/apartment-ico.png"></h3> </div>
          ...
          <div class="pkg-section" id="aprment">
           <div class="row">
             <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3>לינה <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_apartment',1) }}</span><img src="{{url('/assets/front/images')}}/rooms.png"></h3></div>
             </div>
          ...
          <div class="pkg-section" id="gallery">
           <div class="row">
            <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3>גלריה <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_gallery',1) }}</span><img src="{{url('/assets/front/images')}}/gallery.png"></h3></div>
             </div>
          ...
          <div class="pkg-section pack_room" id="hotel_rooms">
           <div class="row">
             <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3><img src="{{url('/assets/front/images')}}/apartment-ico.png"> מידע על המלון <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_apartment_info',1) }}</span></h3></div>
             </div>
            @foreach($hotel_rooms as $room)
             <div class="col-md-12 ap-cont">
              <h3 class="cont-head">
          ...
          <div class="pkg-section" id="map">
           <div class="row">
             <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3>אטרקציות באיזור מקום האירוח  <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_attraction',1) }}</span><img src="{{url('/assets/front/images')}}/location.png"></h3></div>
             </div>
          ...
          <div class="pkg-section" id="flights">
           <div class="row flt-inner">
             <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3>טיסה <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_flights',1) }}</span><img src="{{url('/assets/front/images')}}/flight-ico.png"></h3></div>
             </div>
                ...
                @foreach($all_flights as $all_flight)
                    <div class="flight-conttt">
                          ...
                          @foreach($all_flight['up_flights'] as $flight)
                           <div class="flight-secc top">
                             <div class="flights-icon">
                              <img width="262" height="165" src="{{url('ramtours/'.$flight['airline_logo'])}}" class="img-fluid" alt="">
                               <div class="flt_inff"><span class="fltt_name">{{
                          ...
                          @if(empty($all_flight['down_flights']))
                            <div class="flight-secc bottom">
                               <div class="flights-icon">
                                <img width="262" height="165" src="{{url('ramtours/'.$all_flight['down_airline_logo'])}}" class="img-fluid" alt="">
                                 <div class="flt_inff"><span class="fltt_name">{{
                               ...
                               <div class="flight-text-box tf3">
                                ...
                                <span class="fltt-ttltime">
                                   {{'טיסת '.$all_flight['down_flight_no']}} {{ $all_flight['down_source'] }} ל{{$all_flight['up_desti']}}
                                 </span>
                              </div>
                               <div class="flight-text-box tf4"></div>
                               <div class="clear"></div>
          ...
          <div class="pkg-section" id="car">
           <div class="row">
             <div class="col-md-12 bd-sec">
              <div class="bd-head"><h3>רכב  <span class="rt_headd"> {{ get_rami_page_placeholder('help_text_vehicle',1) }}</span><img src="{{url('/assets/front/images')}}/pkg-car.png"></h3></div>
             </div>
             <div class="col-md-8">
