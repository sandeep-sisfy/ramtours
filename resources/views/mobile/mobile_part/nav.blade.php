               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-collapse">
                     ...
                     <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item">
                           <a class="nav-link js-scroll-trigger {{ get_rami_active_menu('') }}" href="{{url('/')}}">דף הבית</a>
                        </li>
                        {{-- vacation packages --}}
                        <li class="nav-item dropdown">
                           <a href="#" class="nav-link {{ get_rami_active_menu('vacation-packages') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">חבילות נופש</a>                           <ul class="dropdown-menu" role="menu">
                                 <li class=""><a class="dropdown-item" href="{{ url('/package-category/21') }}">בילות נופש באיזור היער השחור גרמניה</a></li>
                                 <!-- <li class=""><a href="{{ url('/package-category/53') }}" class="dropdown-item">חבילות ליער השחור ראש השנה סוכות</a></li> -->
                                 <li class=""><a href="{{ url('/package-category/55') }}" class="dropdown-item">חבילות הנופש באיזור זלצבורג אוסטריה  </a></li>
                                 ...
                                 <li class=""><a href="{{ url('/package-category/82') }}" class="dropdown-item">חחבילות נופש להולנד  </a></li>
                        ...
                        {{-- <li class="nav-item dropdown"> 
                           ...
                           <ul class="dropdown-menu" role="menu">
                              <li class=""><a href="{{ url('/package-category/21') }}" class="dropdown-item">חבילות טוס וסע לפרנקפורט</a></li>
                              <li class=""><a href="{{ url('/package-category/21') }}" class="dropdown-item">חבילות טוס וסע למינכן</a></li>
                              <li class=""><a href="{{ url('/package-category/21') }}" class="dropdown-item">חבילות טוס וסע לציריך</a></li>
                              <li class=""><a href="{{ url('/package-category/21') }}" class="dropdown-item">חבילות טוס וסע לבריסל</a></li>
                           </ul>
                        </li> --}}
                        {{-- Accomodation --}}
                        <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu" role="menu">
                              <li class="dropdown-item dropdown">
                                 <a href="javascript:void(0)" class="dropdown-toggle {{ get_rami_active_menu('accommodation') }}">
                               לינה בגרמניה  </a>
                              ...
                              <li class="dropdown-item dropdown">
                                 <a href="javascript:void(0)" class="dropdown-toggle {{ get_rami_active_menu('accommodation') }}">לינה באוסטריה</a>
                                 <ul class="dropdown-menu">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                           <li class="dropdown-item dropdown">
                           <a href="javascript:void(0)" class="dropdown-toggle {{ get_rami_active_menu('flights') }}">הולנד</a>
                              <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown-item"><a href="{{ url('/נופש-בהולנד-למשפחות') }}">ופש בהולנד למשפחות</a></li>
                           ...
                           <li class="dropdown-item dropdown">
                              ...
                              <ul class="dropdown-menu">
                                 ...
                                 <li class="dropdown-item"><a href="{{ url('/package-category/דילים-ליער-השחור') }}">טילים ליער השחור</a></li>
                           ...
                           <li class="dropdown-item dropdown">
                              ...
                              <ul class="dropdown-menu">
                                 <li class="dropdown-item"><a href="{{ url('/היער-השחור-גרמניה') }}">טיול מאורגן לאוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/package-category/דילים-ליער-השחור/') }}">טיול באוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/flights/טיסות-ליער-השחור') }}">כפר נופש באוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/היער-השחור-עם-ילדים') }}">דילים לאוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/טיול-מאורגן-ליער-השחור-למשפחות') }}">חבילות נופש לאוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/טיול-ליער-השחור') }}">טיסות לזלצבורג</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/כפר-נופש-ביער-השחור') }}">טיול לאוסטריה עם ילדים</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/חופשה-ביער-השחור') }}">אוסטריה למשפחות</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/כרטיס-היער-השחור-החדש-schwarzwaldcard') }}">צימרים באוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/מלונות-מומלצים-ביער-השחור') }}">דירות נופש באוסטריה</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/accommodation/לינה-ביער-השחור') }}">צימרים בזלצבורג</a></li>
                                 <li class="dropdown-item"><a href="{{ url('/צימרים-ודירות-נופש-ביער-השחור') }}">דירות נופש בזלצבורג</a></li>                          
                              </ul> 
                           </li>
                           <li class="dropdown-item dropdown">
