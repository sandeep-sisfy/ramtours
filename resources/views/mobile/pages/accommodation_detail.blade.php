...
@section('mobile_container')
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="rt_btnsec">
                     <div class="accom_ico"><a href="#"><img src="{{url('/assets/mobile')}}/images/ac-detail.png" alt=""></a></div>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               ...
               <div class="col-sm-12 rt-inner listpkg">
                  ...
                  <div class="rtpkglst">
                     ...
                     <h4>פרטי המלון</h4>
                     <div class="pkg_btnn"><a href="javascript:void(0)" id="accom_ginfo_btn"><img src="{{url('assets/mobile')}}/images/pkg-arrow-yellow.png" class="inf_arrow"></a></div>
                  </div>
                  <div class="rtpkglst">
               ...
               <div class="col-sm-12 accom_sec">
                  ...
                  <div class="terms-form-box" id="accom-form" style="display:none">
                     <div class="terms-heading">
                        <div class="contact-time-icon term-icon"><img src="{{url('assets/mobile')}}/images/recomend-form-icon.jpg" alt=""></div>
                     ...
                     <form id="create_testimonial_form" method="post" action="" enctype="multipart/form-data">
                        <div class="opinion-input-box accom_str">          
                           ...
                           <img class="rating_star" src="{{url('assets/mobile')}}/images/grey-star.png" alt="" val-attr="1">
                           <img class="rating_star" src="{{url('assets/mobile')}}/images/grey-star.png" alt="" val-attr="2">
                           <img class="rating_star" src="{{url('assets/mobile')}}/images/grey-star.png" alt="" val-attr="3">
                           <img class="rating_star" src="{{url('assets/mobile')}}/images/grey-star.png" alt="" val-attr="4">
                           <img class="rating_star" src="{{url('assets/mobile')}}/images/grey-star.png" alt="" val-attr="5">
                           </span>
                        </div>
      ...
      <section class="accom_frms">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h3 class="pkg_head">{{ get_location_name($hotel_location) }} לינה נוספות באיזור טירול</h3>
               </div>
                  ...
                  @foreach($similar_loc_hotels as $hotel_new)             
                   <div class="rt-packframes filterable">
                         <div class="accomm-right col-6 col-sm-6">
                           <a href="{{ url('/accommodation/'.$hotel_new->id) }}"><img width="340" height="214" src="{{rami_get_hotel_single_image($hotel_new->id)}}" class="img-fluid" alt=""></a>
                           <div class="rt-code">
                             <div class="dates"></div>
                         ...
                         <div class="accomm-left col-6 col-sm-6">
                           ...
                           <div class="accomm-heading"><h5>{{ $hotel->hotel_display_name }}</h5></div>
                     ...
                     <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse{{$loop->index}}" aria-expanded="false" aria-controls="collapseOne">
                        <div class="bd-sec ap_slect">
                           <div class="bd-head">
                              ...
                              <h3>
                                  <span> 
                                     <img src="{{url('/assets/front/images')}}/ramtours-rooms.png"> חדרים -{{$room['room_area']}} מ"ר  |
                                    </span>
                                    <span>
