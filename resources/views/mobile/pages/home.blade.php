            ...
            <div class="row">
               <div class="col-sm-12 rt-inner home_packs">
                  ...
                  @foreach($packages as $pack)
                    {!! rami_vacation_pkg_mobile_html($pack) !!}
                  @endforeach
               </div>
               @if($show_load_more==1)
               ...
               <div class="col-sm-12">
                  ...
                  <div class="rt-spec">
                     <div class="col-6 col-sm-6 rt-specinner">
                        <a href="javascript:void(0)"> <img src="{{url('assets/mobile')}}/images/spec-2.png" class="img-fluid" alt=""></a>
                        <h3 class="sp_dsc">חבילת נופש לאוסטריה
                           מתחיל מ 679 €
                        </h3>
                     </div>
                     <div class="col-6 col-sm-6 rt-specinner">
                        <a href="javascript:void(0)"> <img src="{{url('assets/mobile')}}/images/spec-1.png" class="img-fluid" alt=""></a>
                        <h3 class="sp_dsc">חבילת נופש ליער השחור
                           מתחיל מ 439 €
                        </h3>
                     </div>
                     <div class="col-6 col-sm-6 rt-specinner">
                        <a href="javascript:void(0)"> <img src="{{url('assets/mobile')}}/images/spec-4.png" class="img-fluid" alt=""></a>
                        <h3 class="sp_dsc">חבילת נופש לגרמניה
                           החל מ 499 €
                        </h3>
                     </div>
                     <div class="col-6 col-sm-6 rt-specinner">
                        <a href="javascript:void(0)"><img src="{{url('assets/mobile')}}/images/spec-3.png" class="img-fluid" alt=""></a>
   ...
   @parent
    ...
    $('.rami_load_more_btn_div').on('click', '.rami_load_more_btn', function(event) {
      ...
      $.ajax({
        url: '/load_more',
        type: 'POST',
        data: {_token:'{{csrf_token()}}', page:page,type:2,no_of_element:4},
      })
      .done(function(res) {        
