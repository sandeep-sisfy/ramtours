         ...
         @for($a=1; $adults >= $a; $a++)
           ...
           <div class="order-heading">ילדים  {{$a}}</div>
            <div class="orderinfo_sec">
              ...
              <select name="traveller_child_{{$a}}_sex">
                    <option value="male" {{get_edit_select_check_pvr_old_value('traveller_child_'.$a.'_sex', '', 'male', 'select')}}>זכר</option>
                    <option value="female" {{get_edit_select_check_pvr_old_value('traveller_child_'.$a.'_sex', '', 'female', 'select')}}>נקבה</option>
              </select>
           ...
           <div class="order-heading">תינוק  {{$a}}</div>
            <div class="orderinfo_sec">
              ...
              <select name="traveller_infant_{{$a}}_sex">
                    <option value="male" {{get_edit_select_check_pvr_old_value('traveller_infant_'.$a.'_sex', '', 'male', 'select')}}>זכר</option>
                    <option value="female" {{get_edit_select_check_pvr_old_value('traveller_infant_'.$a.'_sex', '', 'female', 'select')}}>נקבה</option>
              </select>
          ...
          @endfor
                  ...
                  <div class="orderinfo_sec">
                    ...
                    <div class="rt_flds">
                     <div class="check-b1 rt_mobileno"><input name="payer_home_phone" type="number" class="contact-input" placeholder="טלפון" value="{{get_edit_input_pvr_old_value('payer_home_phone')}}" maxlength="7" >
                      {!! get_form_error_msg($errors, 'payer_home_phone') !!}
                    </div>
                    <div class="rt_droparrow rt_stdcode">
                     <select name="home_code">
                        <option value="">בחר</option>
                        <option value="02" {{get_edit_select_check_pvr_old_value('mobile_code', '', 2, 'select')}}>02</option>
                        <option value="03" {{get_edit_select_check_pvr_old_value('mobile_code', '', 3, 'select')}}>03</option>
                        <option value="04" {{get_edit_select_check_pvr_old_value('mobile_code', '', 3, 'select')}}>04</option>
                        <option value="08" {{get_edit_select_check_pvr_old_value('mobile_code', '', 8, 'select')}}>08</option>
                        <option value="09" {{get_edit_select_check_pvr_old_value('mobile_code', '', 9, 'select')}}>09</option>
                        <option value="072" {{get_edit_select_check_pvr_old_value('mobile_code', '', 72, 'select')}}>072</option>
                        <option value="073" {{get_edit_select_check_pvr_old_value('mobile_code', '', 73, 'select')}}>073</option>
                        <option value="074" {{get_edit_select_check_pvr_old_value('mobile_code', '', 74, 'select')}}>074</option>
                        <option value="075" {{get_edit_select_check_pvr_old_value('mobile_code', '', 75, 'select')}}>075</option>
                        <option value="076" {{get_edit_select_check_pvr_old_value('mobile_code', '', 76, 'select')}}>076</option>
                        <option value="077" {{get_edit_select_check_pvr_old_value('mobile_code', '', 77, 'select')}}>077</option>
                      </select>
                    ...
                    <div class="check-b1 rt_mobileno">
                     <input name="payer_mobile_phone" type="number" class="contact-input" placeholder="נייד" value="" maxlength="7" value="{{get_edit_input_pvr_old_value('payer_mobile_phone')}}">
                     ...
                     <input name="payer_city" type="text" class="contact-input" placeholder="*עיר / ישוב" value="" value="{{get_edit_input_pvr_old_value('payer_city')}}">
                ...
                + מסמכי הנסיעה יתקבלו בדואר אלקטרוני, במקרה הצורך יתואם איסוף המסמכים מבית ״רם נסיעות ותיירות״</p>
                     ...
                     <div class="filter_cont custom-control custom-checkbox"> <input type="checkbox" class="custom-control-input" id="chk-b1" name="payer_terms" value="1" {{get_edit_select_check_pvr_old_value('payer_terms', '', 1, 'check')}}>
