            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="rt_info_right">
                     <h3 class="rtpkghead">חבילת נופש ל @if(!empty($package->package_desti)){{$package->package_desti->loc_name}}@endif</h3>
                     <div class="date"><i class="fa fa-calendar" aria-hidden="true"></i>{{ rami_get_require_date_format($package->package_end_date, 'd/m').' - ' .rami_get_require_date_format($package->package_start_date, 'd/m') }} </div>
                  </div>
                  <div class="rt_btnsec">
            ...
            <div class="row">
               <div class="col-sm-12 rt-inner abtpkg">
                 ...
                 <!-- <h5>  החבילה כוללת:     </h5>-->
                  ...
                  <p class="rt_dts" style="display: none">משפחתי סטיישן   {{rami_get_no_of_days_diff($package->package_start_date, $package->package_end_date)}} ימים   </p>
               </div>
               <div class="col-sm-12 rt-inner listpkg">
                  <h3 class="pkg_head">לינה  : <span class="rt_headd">{{ get_rami_page_placeholder('help_text_apartment',1) }}</span></h3>
                  <div class="rtpkglst">
                     <img src="{{url('assets/mobile/images/rooms.png')}}" alt="">
                     <h4>פרטי המלון</h4>
                     <div class="pkg_btnn"><a href="JavaScript:Void(0);" id="rt_lodging_btn"><img src="{{url('assets/mobile/images/pkg-arrow-yellow.png')}}" class="inf_arrow"></a></div>
                  </div>
                  <div class="rtpkglst">
               ...
               <div class="col-sm-12 flt-inner pkgflt_secc">
                  <h3 class="pkg_head">טיסות   : <span class="rt_headd">{{ get_rami_page_placeholder('help_text_flights',1) }}</span></h3>
               ...
               <div class="col-sm-12 car-inner">
                  <h3 class="pkg_head">רכב  : <span class="rt_headd">{{ get_rami_page_placeholder('help_text_vehicle',1) }}</span></h3>
