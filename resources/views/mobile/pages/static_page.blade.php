    ...
    <div class="row">
      ...
      <div class="col-sm-12 bfleftnav">
        <div class="content-right-nav">
          ...
          <div class="content-nav-heading"><span>{{$page->menu_title}} </span><img
              src="{{url('assets/mobile')}}/images/rt_menu.png" class="bfmenu"></div>
          @else
          <div class="content-nav-heading">$page->page_title <img src="{{url('assets/mobile')}}/images/rt_menu.png"
              class="bfmenu"></div>
          @endif
