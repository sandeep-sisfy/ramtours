          ...
          <tbody>
            ...
            <tr>
               <td colspan="2" valign="middle">
                  <table style="padding:10px 0 5px 0;">
                   <tr>
                     <td width="40" height="40"><img width="40" height="40" src="{{base_path().'/public/assets/pdf/images/passenger.png'}}" class="img-fluid" alt="">
                    </td>
            ...
            <tr>
               <td colspan="2" valign="middle">
                  <table style="padding:10px 0 5px 0;">
                   <tr>
                     <td width="40" height="40"><img width="40" height="40" src="{{base_path().'/public/assets/pdf/images/flight.png'}}" class="img-fluid" alt="">
                    </td>
                              ...
                              <table class="order_inner flight-sec" border="0">
                                 <tbody>
                                  <tr>
                                    ...
                                    <td align="left" class="order_inner_head" width="27%">משך טיסה כולל  {{$all_flight['up_time_taken']}}</td>
                                   </tr>
                                   @if(empty($all_flight['up_flights']))
                                    <tr>
                                    <td> <img width="50" src="{{base_path().'\\public\\ramtours\\'.$all_flight['up_airline_logo']}}" class="img-fluid" alt="">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td align="center">{{$all_flight['up_source']}}<br><span class="rt_tmm">{{$all_flight['up_departure_time']}}</span> <br> {{$all_flight['up_departure_time_in_month_date']}}   </td>
                                            <td align="center"><img width="18" src="{{base_path().'/public/assets/pdf/images/plane_ico.png'}}"></td>
                                            <td align="center"> {{$all_flight['up_desti']}}<br><span class="rt_tmm">{{$all_flight['up_arrival_time']}}</span><br> {{$all_flight['up_arrival_time_in_month_date']}} </td>
                                        </tr>
                                    </tbody>
                                    </table>
                                    </td>
                                    <td align="center">  <span class="fltt-info">פרטי הטיסה </span><br>
                                          <span class="fltt-ttltime"> {{'טיסת '.$all_flight['up_flight_no']}} {{ $all_flight['up_source'] }} ל{{$all_flight['up_desti']}}</span>
                                 ...
                                 @foreach($all_flight['up_flights'] as $flight)
                                   <tr>
                                    <td> <img width="50" src="{{base_path().'\\public\\ramtours\\'.$flight['airline_logo']}}" class="img-fluid" alt="">
                                    <span class="fltt_name" >{{
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td align="center">{{$flight['source']}}<br><span class="rt_tmm">{{$flight['departure_time']}}</span> <br> {{$flight['depart_time_in_month_date']}}   </td>
                                            <td align="center"><img width="18" src="{{base_path().'/public/assets/pdf/images/plane_ico.png'}}"></td>
                                            <td align="center"> {{$flight['desti']}}<br><span class="rt_tmm">{{$flight['arrival_time']}}</span><br> {{$flight['arrival_time_in_month_date']}} </td>
                                        </tr>
                                    </tbody>
                                    </table>
                                    </td>
                                    <td align="center">  <span class="fltt-info">פרטי הטיסה </span><br>
                                          <span class="fltt-ttltime"> {{'טיסת '.$flight['flight_no']}} {{ $flight['source'] }} ל{{$flight['desti']}}</span>
                                 ...
                                 @endif
                                  <tr>
                                    ...
                                    <td align="left" class="order_inner_head" width="27%">משך טיסה כולל  {{$all_flight['down_time_taken']}}</td>
                                  </tr>
                                  @if(empty($all_flight['down_flights']))
                                    <tr>
                                    <td> <img width="50" src="{{base_path().'\\public\\ramtours\\'.$all_flight['down_airline_logo']}}" class="img-fluid" alt="">
                                    <span class="fltt_name" >{{
                                    ...
                                    <table>
                                        <tbody><tr>
                                            <td align="center">{{$all_flight['down_source']}}<br><span class="rt_tmm">{{$all_flight['down_departure_time']}}</span> <br> {{$all_flight['down_departure_time_in_month_date']}}   </td>
                                            <td align="center"><img width="18" src="{{base_path().'/public/assets/pdf/images/plane_ico.png'}}"></td>
                                            <td align="center"> {{$all_flight['down_desti']}}<br><span class="rt_tmm">{{$all_flight['down_arrival_time']}}</span><br> {{$all_flight['down_arrival_time_in_month_date']}} </td>
                                        </tr>
                                    </tbody>
                                    </table>
                                    </td>
                                    <td align="center">  <span class="fltt-info">פרטי הטיסה </span><br>
                                          <span class="fltt-ttltime"> {{'טיסת '.$all_flight['down_flight_no']}} {{ $all_flight['down_source'] }} ל{{$all_flight['down_desti']}}</span>
                             ...
                             <table border="0" class="chead">
                                 <tr>
                                     <td valign="middle">
                                          <table style="padding:10px 0 5px 0;">
                                           <tr>
                                             <td width="40" height="40"><img width="40" height="40" src="{{base_path().'/public/assets/pdf/images/car.png'}}" class="img-fluid" alt="">
                                            </td>
                                     ...
                                     <td valign="middle">
                                          <table style="padding:10px 0 5px 0;">
                                           <tr>
                                             <td width="40" height="40"><img width="40" height="40" src="{{base_path().'/public/assets/pdf/images/hotel.png'}}" class="img-fluid" alt="">
                                            </td>
                                 ...
                                 <tbody>
                                      ...
                                      <td class="quantity" width="40%">
                                          ...
                                          @if(!empty($hotel->hotel_address))
                                            <strong>כתובת המלון :&nbsp;&nbsp;</strong>{{$hotel->hotel_address}}<br/>
                                          @endif
                        ...
                        @endif   
                         <tr>
                          <td colspan="4" valign="middle" >
                                  <table style="padding:10px 0 5px 0;">
                                   <tr>
                                     <td width="40" height="40"><img width="40" height="40" src="{{base_path().'/public/assets/pdf/images/customer.png'}}" class="img-fluid" alt="">
                                    </td>
                                    <td align="right" height="40"><h2 style="line-height:30px">  פרטי לקוח משלם  </h2> </td>
                                      </tr>
                                  </table>
                               </td>
                         </tr>
