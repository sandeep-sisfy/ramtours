      <?php $__env->startSection('rami_mobile_footer'); ?>
      <footer>
    ...
    <div class="modal-dialog">
            ...
            <div class="row">
               <div class="col-6 col-sm-6 footerFB">
                  <ul class="rt_socialico">
                     ...
                     <li><a href="<?php echo e(url('/contact')); ?>"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
      ...
      <?php echo $__env->yieldSection(); ?><?php /**PATH /home/newssurl/domains/new.s248.upress.link/public_html/resources/views/mobile/mobile_part/footer.blade.php ENDPATH**/ ?>