                     ...
                     <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item dropdown">
                           <a href="#" class="nav-link <?php echo e(get_rami_active_menu('vacation-packages')); ?>" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">חבילות נופש</a>                           <ul class="dropdown-menu" role="menu">
                                 <li class=""><a class="dropdown-item" href="<?php echo e(url('/package-category/21')); ?>">בילות נופש באיזור היער השחור גרמניה</a></li>
                                 <!-- <li class=""><a href="<?php echo e(url('/package-category/53')); ?>" class="dropdown-item">חבילות ליער השחור ראש השנה סוכות</a></li> -->
                                 <li class=""><a href="<?php echo e(url('/package-category/55')); ?>" class="dropdown-item">חבילות הנופש באיזור זלצבורג אוסטריה  </a></li>
                                 ...
                                 <li class=""><a href="<?php echo e(url('/package-category/82')); ?>" class="dropdown-item">חחבילות נופש להולנד  </a></li>
...
<?php /**PATH /home/eli/ramtours/resources/views/mobile/mobile_part/nav.blade.php ENDPATH**/ ?>