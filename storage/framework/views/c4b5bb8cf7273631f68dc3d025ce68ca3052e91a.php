     ...
     <div class="row">
      <div class="col-md-12">
       <div class="inner-page-breadcrum">
          <strong>::</strong> 
          <a href="<?php echo e(url('/')); ?>">דף הבית </a>
    ...
    <div class="container">
       <div class="row">
        <div class="col-lg-12 text-center">
              <h2 class="section-heading"><?php echo e($page_title); ?> </h2>
        </div>
       <!-- <?php echo rami_package_hotel_filter_html(); ?>-->
        <div class="col-lg-12">
          <?php $__currentLoopData = $show_settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php if(!empty($setting['results'])): ?>
              <?php if(!empty($setting['section_title'])): ?>
              <div class="row">
                <div class="col-lg-12 text-center">
                  <h2 class="section-heading text-right"><?php echo e($setting['section_title']); ?></h2>
                </div>
              </div>
              <?php endif; ?>
              <div class="row text-center pakage_div">
               <?php $__currentLoopData = $setting['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkgs_fhc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>           
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.home_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/newssurl/domains/new.s248.upress.link/public_html/resources/views/frontend/pages/vacation_packages.blade.php ENDPATH**/ ?>