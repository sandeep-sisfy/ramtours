        ...
        <div class="col-lg-12">
          ...
          <?php if(!empty($show_load_more)): ?>
           <div class="col-md-12 load_more_hotels_div">
            <input type="hidden" name="hotel_code_text" value="<?php echo e($hotel_code_text); ?>">
  ...
  <script type="text/javascript">
    $('.load_more_hotels_div').on('click', '.load_more_hotels', function(event) {
      ...
      $.ajax({
        url: '/hotel_load_more',
        type: 'POST',
        data: {_token:'<?php echo e(csrf_token()); ?>', page:page,no_of_element:8, hotel_code:hotel_code},
      })
      .done(function(res) {        
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.home_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/newssurl/domains/new.s248.upress.link/public_html/resources/views/frontend/pages/accommodation_search_hotel_code.blade.php ENDPATH**/ ?>