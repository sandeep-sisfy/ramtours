         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <div class="rt_btnsec">
                     <div class="pgico"><a href="#"><img src="<?php echo e(url('assets/mobile')); ?>/images/map-icon.png" alt=""></a></div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="contact-frm col-sm-12">
                  <div class="contact-time-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/contact-form-icon.jpg" alt=""></div>
          ...
          <input type="submit" value="שלח" class="wpcf7-form-control wpcf7-submit contact-submit"><span class="ajax-loader">
               ...
               <div class="contact-frm-details col-sm-12">
                  <div class="content-height">
                     <div class="contact-time-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/location-icon.jpg" alt=""></div>
                  ...
                  <div class="urgent-call">
                     <div class="urgent-call-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/email-icon.jpg" alt=""></div>
                     <div class="contact-content-box">
               ...
               <div class="contact-frm col-sm-12">
                  <div class="content-height">
                     <div class="contact-time-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/contact-time-icon.jpg" alt=""></div>
                  ...
                  <div class="contact-border"></div>
                  <div class="urgent-call">
                     <div class="urgent-call-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/phone-icon.jpg" alt=""></div>
                     <div class="contact-content-box">
               ...
               <div class="contact-frm col-sm-12">
                  <div class="contact-time-icon"><img src="<?php echo e(url('assets/mobile')); ?>/images/i-icon.png" alt=""></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mobile.home_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/newssurl/domains/new.s248.upress.link/public_html/resources/views/mobile/pages/contact.blade.php ENDPATH**/ ?>