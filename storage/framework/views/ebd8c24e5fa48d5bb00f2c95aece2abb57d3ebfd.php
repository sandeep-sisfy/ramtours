<?php $__env->startSection('rami_front_container'); ?>
  <?php if(!empty($show_setting)): ?>
 <!-- <nav class="navbar navbar-expand-lg navbar-dark" id="rt_affix">
    <div class="container">
      <ul class="navbar-nav text-uppercase ml-auto rt_tabs">
         <?php $__currentLoopData = $show_setting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php if((!empty($setting['menu_title']))&&(!empty($setting['results']))): ?>
                  <?php if($loop->index==0): ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger active" href="#nav_<?php echo e($setting['id']); ?>"><?php echo e($setting['menu_title']); ?></a>
                    </li>
                  <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#nav_<?php echo e($setting['id']); ?>"><?php echo e($setting['menu_title']); ?></a>
                    </li>
                  <?php endif; ?>
            <?php endif; ?>
  ...
  <?php if(!empty($show_setting)): ?>
    <?php $__currentLoopData = $show_setting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if(!empty($setting['results'])): ?>
        <section class="rt_frames" id="nav_<?php echo e($setting['id']); ?>">
          <div class="container">
            <div class="row text-center page-section" >
              <?php if(!empty($setting['section_title'])): ?>
              <div class="col-lg-12 text-center">
                <h2 class="section-heading"><?php echo e($setting['section_title']); ?></h2>
              </div>
              <?php endif; ?>
                 <?php $__currentLoopData = $setting['results']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($setting['package_type']==1): ?>
                      <?php echo rami_vacation_pkg_html($result); ?>

                    <?php elseif($setting['package_type']==3): ?>
                      <?php echo rami_fly_drive_pkg_html($result); ?>

                    <?php elseif($setting['package_type']==4): ?>
                      <?php echo rami_flight_pkg_html($result); ?>
...
<?php echo $__env->make('frontend.home_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/newssurl/domains/new.s248.upress.link/public_html/resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>